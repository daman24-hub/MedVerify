...
router.post(
	...
	[
		...
		body('lat').optional({ nullable: true, checkFalsy: true }).isNumeric(),
		body('lng').optional({ nullable: true, checkFalsy: true }).isNumeric(),
		body('latitude').optional({ nullable: true, checkFalsy: true }).isNumeric(),
		body('longitude').optional({ nullable: true, checkFalsy: true }).isNumeric(),
